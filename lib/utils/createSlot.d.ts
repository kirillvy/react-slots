...
interface IOverloadCreateSlot {
    (Element: keyof JSX.IntrinsicElements | React.ComponentType<any>, renderIn?: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponent;
    <T extends keyof JSX.IntrinsicElements>(Element: T | React.ComponentType<any>, renderIn?: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponent<Partial<JSX.IntrinsicElements[T]>>;
    <T extends {}>(Element?: React.ComponentType<any>, renderIn?: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponent<T>;
    <S extends keyof JSX.IntrinsicElements, T extends {}>(Element?: React.ComponentType<any>, renderIn?: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponent<T & Partial<JSX.IntrinsicElements[S]>>;
    <T extends {}, S extends keyof JSX.IntrinsicElements>(Element?: React.ComponentType<any>, renderIn?: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponent<T & Partial<JSX.IntrinsicElements[S]>>;
}
interface IOverloadCreateLayeredSlot {
    (Element: keyof JSX.IntrinsicElements | React.ComponentType<any>, renderIn: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponentExtended;
    <T extends keyof JSX.IntrinsicElements>(Element: T | React.ComponentType<any>, renderIn: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponentExtended<Partial<JSX.IntrinsicElements[T]>>;
    <T extends {}>(Element: React.ComponentType<any>, renderIn: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponentExtended<T>;
    <S extends keyof JSX.IntrinsicElements, T extends {}>(Element: React.ComponentType<any>, renderIn: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponentExtended<T & Partial<JSX.IntrinsicElements[S]>>;
    <T extends {}, S extends keyof JSX.IntrinsicElements>(Element: React.ComponentType<any>, renderIn: React.ComponentType<any> | keyof JSX.IntrinsicElements): ISlotComponentExtended<T & Partial<JSX.IntrinsicElements[S]>>;
}
